 ...
 */
class RateAdapter(var rates: List<Rate>, val clickListener: (Rate) -> Unit) : RecyclerView.Adapter<RateAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //bind views
        holder.currency.text = currency.displayName + " ("+currency.symbol+")"
        holder.rate.text = rate.rate.toString()
